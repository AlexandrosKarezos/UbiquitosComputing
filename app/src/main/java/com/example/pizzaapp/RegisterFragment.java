...
public class RegisterFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editTextLastName= (EditText) view.findViewById(R.id.rSurnameInputET);
        editTextFirstName= (EditText) view.findViewById(R.id.rNameInputET);
        editTextStreet= (EditText) view.findViewById(R.id.rStreetInputET);
        editTextPostCode= (EditText) view.findViewById(R.id.rPlzInputET);
        editTextStreetNumber= (EditText) view.findViewById(R.id.rHnrInputET);
        editTextCity= (EditText) view.findViewById(R.id.rCityInputET);
        editTextPassword= (EditText) view.findViewById(R.id.rPasswordInputPT);
        editTextUsername= (EditText) view.findViewById(R.id.rUsernameInputET);
        editTextEmail= (EditText) view.findViewById(R.id.rEmailInputET);
